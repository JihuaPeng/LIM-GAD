...
from .group_transformer_MDAF import build_group_transformer
...
class GADTR(nn.Module):
    def __init__(self, args):
        ...
        self.num_act_tokens = args.num_act_tokens


        # [ACT] embedding activity classfication head
        self.act_emb_class = nn.Linear(self.hidden_dim, self.num_class + 1)
