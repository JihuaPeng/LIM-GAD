...
# ------------------------------------------------------------------------
from .cafe_videolisa_12group_boxes_prompt import *
...
def read_dataset(args):
    if args.dataset == 'cafe':
        ...
        train_set = CafeDataset(vision_tower, train_frames, train_data, all_tracks, data_path, args, is_training=True)
        test_set = CafeDataset(vision_tower, test_frames, test_data, all_tracks, data_path, args, is_training=False)
    else:
        assert False
